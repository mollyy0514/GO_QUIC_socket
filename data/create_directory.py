...
dates = ["2024-03-13"]
exp_names = ["QUIC-1M", "QUIC-5M", "QUIC-10M", "UDP-1M", "UDP-5M", "UDP-10M"]
...
#         create_directory_structure(date_dir, exp_name, device_names)
...
#     mi2log_dir = os.path.join(root_dir, date, "mi2log")
